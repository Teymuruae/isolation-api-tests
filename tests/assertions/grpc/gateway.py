...
def assert_get_account_details_response_user_with_active_debit_card_account(
    ...
    expected = GetAccountDetailsResponse(
        details=AccountDetails(
            account=Account(
                id="78406712-8e22-4901-a8dc-961fd5ce0f78",
                type=AccountType.ACCOUNT_TYPE_DEBIT_CARD,
                status=AccountStatus.ACCOUNT_STATUS_ACTIVE,
                user_id="ef1bd879-469d-47e6-9ee1-b5d0db477d71",
                balance= -15230.75,
            ),
            cards=[
                Card(
                    ...
                    account_id="78406712-8e22-4901-a8dc-961fd5ce0f78",
                    card_number="4111111111111111",
                    card_holder="ALEX PUSHKIN",
                ...
                Card(
                    ...
                    status=CardStatus.CARD_STATUS_ACTIVE,
                    account_id="4415c28b-b27b-4297-a7a9-7aa8c61566bb",
