    ...
    expected = GetAccountDetailsResponseTestSchema(
        details=AccountDetailsTestSchema(
            account=AccountTestSchema(
                id="6d0344f0-85cb-458b-9ba6-7b2a6b29bcd9",
                type=AccountTestType.DEBIT_CARD,
                status=AccountTestStatus.ACTIVE,
                user_id="7097da60-131e-4e0f-a474-7bb3e15b4116",
                balance= 25230.75,
            ),
            cards=[
                CardTestSchema(
                    id="74a0f48a-297e-4bc1-9edf-ac5e730f1a6d",
                    pin="1234",
                    cvv="456",
                    type=CardTestType.VIRTUAL,
                    status=CardTestStatus.ACTIVE,
                    account_id="6d0344f0-85cb-458b-9ba6-7b2a6b29bcd9",
                    card_number="4111111111111111",
                    card_holder="IVAN KUZNECOV",
